...
<html lang="en">
<head>
<title>Oil Industry an Industrial Category Flat Bootstrap Responsive Website Template | Mail :: w3layouts</title>
<!-- custom-theme -->
	...
	<div class="agileits_w3layouts_mail_grids">	
		...
		<div class="col-md-5 w3l_mail_right">
			...
			<ul>
				...
				<li><span><i class="fa fa-globe" aria-hidden="true"></i>Website<label>:</label></span> <a href="https://w3layouts.com/">http://Oilw3layouts.com</a></li>
			</ul>
		</div>
		<div class="clearfix"> </div>
	</div>
